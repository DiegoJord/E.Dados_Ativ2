...
# Implemente um método chamado “aumentar_salario” que recebe um valor percentual
# de aumento e atualiza o salário do funcionário.
...
func1 = Funcionario()
func1.aumentar_salario("Larissa", 3200, "Analista")